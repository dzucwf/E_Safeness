...
import com.safeness.im.adapter.NewFriendsMsgAdapter;
...
public class NewFriendsMsgActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PatientApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME).setUnreadMsgCount(0);
