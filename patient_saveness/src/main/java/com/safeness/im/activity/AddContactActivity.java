...
public class AddContactActivity extends BaseActivity{
	...
	public void addContact(View view){
		if(PatientApplication.getInstance().getUserName().equals(nameText.getText().toString())){
			startActivity(new Intent(this, AlertDialog.class).putExtra("msg", "不能添加自己"));
			return;
		}
		
		if(PatientApplication.getInstance().getContactList().containsKey(nameText.getText().toString())){
