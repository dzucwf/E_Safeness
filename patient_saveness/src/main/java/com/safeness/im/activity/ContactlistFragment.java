...
public class ContactlistFragment extends Fragment {
	...
	public void onSaveInstanceState(Bundle outState) {
	    ...
	    if(((com.safeness.patient.ui.activity.MainActivity)getActivity()).isConflict){
	    	outState.putBoolean("isConflict", true);
	    }else if(((com.safeness.patient.ui.activity.MainActivity)getActivity()).getCurrentAccountRemoved()){
